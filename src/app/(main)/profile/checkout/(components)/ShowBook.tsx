...
export default function ShowBook({ book }: { book: CheckoutType }) {
    ...
    <>
      <div className="flex flex-col relative z-[-10]">
        <div className="relative min-w-[12rem] max-w-[12rem] h-[14rem] mb-4 rounded-lg">
          <Image src={book.book.bookImage} alt="image" fill sizes={"100%"} />
        ...
        <h1 className="w-[12rem] line-clamp-1 text-sm">{book.book.name}</h1>
        <div>
